...
func (_m *UserService) UpdateUserByID(id string, updatedUser domain.User) error {
...
func (_c *UserService_UpdateUserByID_Call) Return(_a0 error) *UserService_UpdateUserByID_Call {
	_c.Call.Return(_a0)
	return _c
}
